function Controller() {
    ...
    shadowGraphLabel ? $.__views.statusViewShadowGraphLabel.addEventListener("click", shadowGraphLabel) : __defers["$.__views.statusViewShadowGraphLabel!click!shadowGraphLabel"] = true;
    ...
    _.extend($, $.__views);
    var ShadowGraph, shadowGraphLabel, webviewBackPage, webviewForwardPage, __slice = [].slice;
    ...
    shadowGraphLabel = function() {
        return $.statusViewShadowGraphLabel.text = "ShadowGraph" === $.statusViewShadowGraphLabel.text ? "@shokuan" : "ShadowGraph";
    };
    $.mainWindow.open();
    __defers["$.__views.statusViewShadowGraphLabel!click!shadowGraphLabel"] && $.__views.statusViewShadowGraphLabel.addEventListener("click", shadowGraphLabel);
